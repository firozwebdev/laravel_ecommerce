...
<head>
   ...
   <link href=" {{ asset('admin_asset/css/style-default.css') }}" rel="stylesheet" />
   <link href=" {{ asset('admin_asset/assets/fullcalendar/fullcalendar/bootstrap-fullcalendar.css') }}" rel="stylesheet" />
   <link href=" {{ asset('admin_asset/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css') }}" rel="stylesheet" />
...
<body class="fixed-top">
       ...
       <div class="navbar-inner">
           <div class="container-fluid">
               ...
               <a class="brand" href="index.html">
                   ...
                   <img src="{{ asset('admin_asset/img/logo.png') }}" alt="Metro Lab" />
               </a>
               <!-- END LOGO -->
   ...
   <script src=" {{ asset('admin_asset/assets/jquery-slimscroll/jquery-ui-1.9.2.custom.min.js') }}"></script>
   <script src=" {{ asset('admin_asset/assets/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
