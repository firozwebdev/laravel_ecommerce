    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4"><!--footer twitter widget-->
                ...
                <a href="index.html#" class="btn btn-default btn-follow"><i class="fa fa-twitter fa-2x"></i><div>Follow us on twitter</div></a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                ...
                <a href="index.html"><div class="payment visa"></div></a>
                <a href="index.html"><div class="payment paypal"></div></a>
                <a href="index.html"><div class="payment mc"></div></a>
                <a href="index.html"><div class="payment nh"></div></a>
            </div>
...
<script src="{{ asset('front-end/ecommerce_asset/bootstrap/js/bootstrap.min.js') }}"></script>

<!-- map -->
<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script>

<script type="text/javascript" src="{{ asset('front-end/ecommerce_asset/js/jquery.ui.map.js') }}"></script>

<script type="text/javascript" src="{{ asset('front-end/ecommerce_asset/js/demo.js') }}"></script>

<!-- owl carousel -->

<script src="{{ asset('front-end/ecommerce_asset/js/owl.carousel.min.js') }}"></script>

<!-- rating -->

<script src="{{ asset('front-end/ecommerce_asset/js/rate/jquery.raty.js') }}"></script>

<script src="{{ asset('front-end/ecommerce_asset/js/labs.js') }}" type="text/javascript"></script>

<!-- Add mousewheel plugin (this is optional) -->

<script type="text/javascript" src="{{ asset('front-end/ecommerce_asset/js/product/lib/jquery.mousewheel-3.0.6.pack.js') }}"></script>

<!-- fancybox -->
<script type="text/javascript" src="http://demo.puriwp.com/shopping/static/js/product/jquery.fancybox.js"></script>

<!-- custom js -->

<script src="{{ asset('front-end/ecommerce_asset/js/shop.js')}}"></script>
</div>
</body>
</html>
