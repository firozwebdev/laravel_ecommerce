    ...
    <div id="sync1" class="owl-carousel">
        <div class="item">
            ...
            <div class="slide-type-1">
                <img src="{{ asset('front-end/ecommerce_asset/images/slide-1.jpg')}}" alt="" class="img-responsive"/>
            </div>
        </div>
        <div class="item">
            <div class="slide-desc">
            ...
            <div class="slide-type-1">
                <img src="{{ asset('front-end/ecommerce_asset/images/slide-2.jpg')}}" alt="" class="img-responsive"/>
            </div>
        </div>
        <div class="item">
            <div class="slide-desc">
            ...
            <div class="slide-type-1">
                <img src="{{ asset('front-end/ecommerce_asset/images/slide-3.jpg')}}" alt="" class="img-responsive"/>
            </div>
        </div>
        <div class="item">
            <div class="slide-desc">
            ...
            <div class="slide-type-1">
                <img src="{{ asset('front-end/ecommerce_asset/images/slide-4.jpg')}}" alt="" class="img-responsive"/>
            </div>
        </div>
        <div class="item">
            <div class="slide-desc">
