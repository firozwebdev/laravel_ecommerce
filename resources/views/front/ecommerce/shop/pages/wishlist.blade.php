                        ...
                        <div class="product-box">
                            ...
                            <div class="hover-block">
                                <ul class="list-inline">
                                    <li><a href="{{ route('ecommerce.product.detail',['id'=>$product->id]) }}" data-toggle="tooltip" data-placement="top" title="Cart"><i class="fa fa-check-circle"" aria-hidden="true"></i></a></li>
                                    <li><a href="{{ route('remove.wishlist',['id'=>$product->id]) }}" data-toggle="tooltip" data-placement="top" title="Wishlist"><i class="fa fa-remove" aria-hidden="true"></i></a></li>
