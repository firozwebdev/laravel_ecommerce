                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                {{Form::text('company_name', $company_name = $billing->company_name, array('class' => 'form-control','id'=>'company_name'))}}
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                {{Form::text('zip', $zip = $billing->zip, array('class' => 'form-control','id'=>'zip'))}}
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                {{Form::text('address', $address = $billing->address, array('class' => 'form-control','id'=>'address'))}}
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                {{Form::text('street_address', $street_address = $billing->street_address, array('class' => 'form-control','id'=>'street_address',  'placeholder' => 'Street Address'))}}
                    ...
                    <div class="row">
                                ...
                                {{Form::label('country', 'Country', array('class' => ''))}}
                                    ...
                                    <select class="form-control select_country" name="country"  tabindex="1">
                                        @foreach($countries as $country)
                                            @if($billing->country == $country->country)
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select_province" name="city"   tabindex="1">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        {{Form::text('mobile', $mobile = $billing->mobile, array('class' => 'form-control','id'=>'mobile'))}}
